...
- I agree but basically the author doesn't know how to write a Makefile for proper cleaning
2. Just to be safe, do a dry run and execute the clean command with the ` -n` option
- Done and nice option to learn
3. Oh noes!  there's a `.c` file that would have been deleted!
- Oh noes people are still saying "noes" in 2025?
